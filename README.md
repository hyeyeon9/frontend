...
## 프로젝트 소개
**Daily24** 는 처음 무인 매장을 운영하는 점주님들을 위한 스마트 매장 관리 시스템입니다. <br>
...
- 두 달 연속 상위권에 있는 품목을 `focusItems`으로 분류
...
## 프로젝트 회고
이번 프로젝트는 조장님과 단둘이서 끝까지 완주한 소중한 경험이었습니다 👍 <br>
중간에 팀 분해라는 예상치 못한 이슈도 있었지만, 오히려 서로를 더 믿고 의지하게 되었고, 그래서인지 더욱 애착이 가는 결과물이 되었습니다.

특히 이 프로젝트를 통해 프론트엔드에 대한 흥미와 가능성을 느낄 수 있었고, <br>
매일 "너가 점주라 생각하고 말해줘!"라며 GPT와 대화하던 날들이 아직도 기억에 남습니다 😂

README를 작성하며 되돌아보니, 기능 하나하나에 쏟은 정성과 설계가 UI에 그대로 녹아든 것 같고, <br>
다시 봐도 버릴 기능 없이 모두 의미 있는 구성이라 더더욱 만족스러운 결과물이라는 생각이 듭니다. 감동의 눈물... 🥲
