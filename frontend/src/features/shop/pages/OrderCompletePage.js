  ...
  return (
    <div className="max-w-[430px] mx-auto bg-gray-50 min-h-screen flex flex-col justify-center items-center px-4">
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold mb-2 text-gray-800">결제가 완료되었습니다!</h1>
        <p className="text-gray-600 mb-6">주문이 성공적으로 처리되었습니다. 곧 상품을 준비하겠습니다.</p>
        ...
        <div className="flex flex-col gap-3">
          <Button as={Link} to="/shop" color="blue" size="lg" className="w-full">
            <Home className="h-4 w-4 mr-2" />
            홈으로 돌아가기
          </Button>
          <Button as={Link} to="/shop/products" color="light" size="lg" className="w-full">
