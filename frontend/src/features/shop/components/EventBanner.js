  ...
  return (
    <div className="mb-4">
      <div className="h-44 rounded-lg overflow-hidden">
        {/* 4월 할인 이벤트 배너 */}
        <div className={`relative  flex h-full items-center justify-center bg-gradient-to-r ${banner.bgColor}`}>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full h-full absolute">
              ...
              <div className="absolute top-4 right-4 bg-red-500 text-white px-3 py-1 rounded-lg transform rotate-12 shadow-lg">
                <span className="text-xs font-bold">최대 30% 할인</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-center text-white p-4 max-w-xs">
            ...
            <Button color="light" size="xs" className="mt-1" onClick={handleViewDiscountedProducts}>
              {banner.buttonText}
            </Button>
          </div>
        </div>
