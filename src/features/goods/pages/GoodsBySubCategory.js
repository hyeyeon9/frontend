        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md mb-6">
            ...
            <div className="relative">
              ...
              {query && (
                <button 
                  onClick={() => {setQuery(''); setFilteredList(goodsList);}}
                ...
                <table className="w-full table-auto border-collapse">
                  <thead>
                    <tr className="bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">
                      <th className="px-6 py-3 cursor-pointer hover:bg-gray-100" onClick={() => requestSort('goods_id')}>
                      ...
                      <th className="px-6 py-3 cursor-pointer hover:bg-gray-100" onClick={() => requestSort('goods_name')}>
                        <div className="flex items-center">
                          상품명
                      ...
                      <th className="px-6 py-3 cursor-pointer hover:bg-gray-100" onClick={() => requestSort('goods_price')}>
                        <div className="flex items-center">
                          가격
                      ...
                      <th className="px-6 py-3 cursor-pointer hover:bg-gray-100" onClick={() => requestSort('goods_created_at')}>
                        <div className="flex items-center">
                          등록일
                      ...
                      <th className="px-6 py-3 cursor-pointer hover:bg-gray-100" onClick={() => requestSort('goods_stock')}>
                        <div className="flex items-center">
                          재고
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {sortedItems.length === 0 ? (
                ...
                sortedItems.map((item) => {
                  const stockStatus = getStockStatus(item.goods_stock);
                  return (
                    <div key={item.goods_id} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                      <div className="relative">
                        <img
                          src={item.goods_image || "/placeholder.svg"}
                          alt={item.goods_name}
                        ...
                        <div className={`absolute top-2 left-2 ${stockStatus.color} px-2 py-1 rounded-full text-xs font-bold`}>
                          {stockStatus.text}
                        </div>
                      </div>
                      <div className="p-4">
